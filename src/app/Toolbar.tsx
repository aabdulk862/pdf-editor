      ...
      {overflowItems.length > 0 && (
        <div className="relative shrink-0" ref={overflowMenuRef}>
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-md text-secondary-600 dark:text-secondary-300 hover:bg-secondary-200 dark:hover:bg-secondary-700 transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500"
