      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`min-w-[44px] min-h-[44px] flex items-center justify-center rounded-md border
            ...
            ${gridEnabled ? 'bg-primary-500 border-primary-500 text-white hover:bg-primary-600' : 'bg-white dark:bg-secondary-800 border-secondary-300 dark:border-secondary-600 text-secondary-500 dark:text-secondary-400 hover:bg-secondary-100 dark:hover:bg-secondary-700 active:bg-secondary-200 dark:active:bg-secondary-600'}`}
